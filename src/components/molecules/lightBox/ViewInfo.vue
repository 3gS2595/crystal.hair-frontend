  ...
  <div class="lightbox-info">
    <div class="infoCol">
      <div>
        ...
        <a v-if="modelValue.signed_url" class="infoBox" :href="modelValue.signed_url" target="_blank">
          <span class="info-title">File Link: </span>{{ modelValue.file_path ? modelValue.file_path :
            modelValue.signed_url }}
        </a>
        ...
        " class="infoBox" :href="'https://www.tumblr.com/' + modelValue.author" target="_blank">
        ...
        <div v-if="(modelValue.description?.length ?? 0) > 1" class="infoBox" style="white-space: normal">
        ...
        <DataView class="dg-0" :value="mixes" dataKey="id1">
          <template #list="slotProps">
            <div v-for="(item, index) in slotProps.items" :key="index" style="display: flex" class="dgb-0">
              ...
              <img @click="search(item.id)" id="open-mix"
