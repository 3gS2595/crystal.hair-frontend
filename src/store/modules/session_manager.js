...
const mutations = {
  setUserInfo (state, data) {
    ...
    axios.defaults.headers.common['Authorization'] = data.headers.authorization // eslint-disable-line
  ...
  resetUserInfo (state) {
    ...
    axios.defaults.headers.common['Authorization'] = null // eslint-disable-line
